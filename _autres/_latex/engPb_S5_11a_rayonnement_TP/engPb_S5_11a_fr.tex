...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%	EngPb_11	/ Electronics and Embedded	
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Created by:
%	Julien VILLEMEJANE - 15/dec/2022
% Modified by:
%	
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{../../../_latex_assets/eng_pb_structure.tex} % Include the document which specifies all packages and structural customizations for this template

\def\dirName{engPb_S5_11}
...
%----------------------------------------------------------------------------------------
\input{ \dirName /\dirName _fr_info.tex}
...
\begin{itemize}
\input{ \dirName /\dirName _fr_concepts.tex}
\end{itemize}
...
%% Short introduction 
\input{ \dirName /\dirName _fr_intro.tex}
...
\begin{enumerate}
\input{ \dirName /\dirName _fr_aav_num.tex}
\end{enumerate}
...
\begin{enumerate}
\input{ \dirName /\dirName _fr_aav_phys.tex}
\end{enumerate}
...
\input{ \dirName /\dirName _fr_livrables.tex}
...
\input{ \dirName /\dirName _fr_steps.tex}
...
\input{ \dirName /\dirName _fr_ressources.tex}
...
\input{ \dirName /\dirName _fr_num_basics.tex}
...
\input{ \dirName /\dirName _fr_num_advanced.tex}
