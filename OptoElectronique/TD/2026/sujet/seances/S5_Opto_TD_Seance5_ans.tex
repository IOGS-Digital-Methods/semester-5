...
On retrouve l'ensemble des éléments précédents.

\begin{center}
	\includegraphics[width=10cm]{images/universel_structure_corr.png}
\end{center}
...
La documentation technique donne $$\omega_n^2 = \frac{R_2}{R_1} \cdot \frac{1}{R_{F1} \cdot R_{F2} \cdot C_1 \cdot C_2}$$

Avec : $C_1 = C_2 = 1000\operatorname{pF}$ et $R_1 = R_2 = \operatorname{k\Omega}$
...
\begin{tikzpicture}
\sbEntree{E}       
\sbBlocL[4]{Int}{$\frac{K_i}{j \cdot \omega}$}{E}
\node[above right=0.25em of E]{$E$};
\sbDecaleNoeudy[4]{Int}{Der}
\sbDecaleNoeudy[-4]{Int}{Prop}
\sbBloc[-1.5]{Der}{$K_d \cdot j \cdot \omega$}{Der}  \sbRelieryx{E-Int}{Der}
\sbBloc[-1.5]{Prop}{$K_p$}{Prop}        \sbRelieryx{E-Int}{Prop}
\sbCompSum{Somme}{Int}{+}{+}{+}{ }
\sbRelier{Int}{Somme}  
