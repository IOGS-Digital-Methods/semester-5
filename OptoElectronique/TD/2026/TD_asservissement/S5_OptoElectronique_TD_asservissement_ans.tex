...
$$H(j \omega) = \frac{K_A}{1 + K_A K_B} \cdot \frac{1 + T_B j \omega}{1 + \frac{T_M}{1 + K_A K_B} j \omega}$$
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item $K_A K_B < 1$		
	\end{itemize}
	\item Donnez également l'expression du gain statique et de la constante de temps de ce système dans les deux conditions précédentes.
\end{enumerate}
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Exercice 5 - Correcteur PID}
