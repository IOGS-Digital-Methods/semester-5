...
sys_fb_I = create_closed_loop(sys_A, sys_I, sys_M)
results_fb[1] = ct.step_response(sys_fb_I, time_pts)
...
plt.plot(time_pts * 1e6, results_fb[1].outputs, label=f'Controlled system - I correction')
plt.xlabel('Time (µs)')
