...
\begin{minipage}{10cm}
    ...
    \textbf{\textsc{\Large Opto-Electronique}}\\[0.1cm]
...
\begin{itemize}
	...
	\item Contraste d'un objectif / FTM
...
Les \textbf{mesures de réflectance} ont été acquises par un \textbf{spectro-colorimètre} de type \textit{KONICA MINOLTA CM2600d} (méthode proposée en TP de photométrie en 2ème année du cursus ingénieur)
...
\section*{Contraste d'un objectif / FTM}

La \textbf{Fonction de Transfert de Modulation} (FTM) (\textit{Modulation Transfer Function} en anglais - \textit{MTF}), permet de caractériser la capacité d'un système optique à restituer les détails d'un objet. Elle décrit comment le \textbf{contraste d'un motif périodique} est transmis par le système \textbf{en fonction de la fréquence spatiale} (c’est-à-dire de la finesse des détails observés).
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{../images/mtf_optics_edmundoptics.png}
    \caption{Courbes FTM pour un objectif de 35 mm à la même WD et à différentes ouvertures : f/4 (a) et f/2 (b). \textbf{\textit{Edmund Optics}}}
    \label{fig:mtf_edmund}
\end{figure}


{\small https://www.edmundoptics.fr/knowledge-center/application-notes/imaging/mtf-curves-and-lens-performance/ } 
