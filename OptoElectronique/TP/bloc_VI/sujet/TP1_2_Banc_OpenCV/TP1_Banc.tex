...
\Quest A partir des dimensions mesurées précédemment (champ de vision) et de la taille du capteur, qu'elle est la taille minimale qu'il est possible de mesurer à l'aide de ce système de vision (côté objet) ?
