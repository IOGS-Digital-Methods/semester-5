...
\begin{itemize}[label=$\blacktriangleright$]
	\item \hyperref[ressource:RLed]{Calculer la \textbf{résistance de protection} d'une diode (LED)}
...
\textit{Ce document est disponible au format électronique sur le site du LEnsE - https://lense.institutoptique.fr/ dans la rubrique Année / Première Année / Opto-Electronique S5 / TP / Bloc Photodétection / Notions et Protocoles.}
...
% Protocoles
\input{ressources/S5_Opto_R_Led.tex}

\input{ressources/S5_Opto_Carac_Statique.tex}

\input{ressources/S5_Opto_Reponse_Indicielle.tex}

\input{ressources/S5_Opto_Reponse_Frequentielle.tex}

\input{ressources/S5_Opto_Bande_Passante.tex}
