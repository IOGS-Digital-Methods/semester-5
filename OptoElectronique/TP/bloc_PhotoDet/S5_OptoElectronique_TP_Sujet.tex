...
\textit{Ce sujet est disponible au format électronique sur le site du LEnsE - https://lense.institutoptique.fr/ dans la rubrique Année / Première Année / Opto-Electronique S5 / TP / Bloc Photodétection / Sujet.}
...
5N-027-SCI \qquad \textbf{\large TP - Photodétection}
...
{\large À l'issue des 4 séances de TP (associées à quelques séances de TD), les étudiant$\cdot$es seront capables de :
...
\textit{Voir feuille de résultats fournie.}
...
\subsection{Feuille de résultats - séances 1 et 2}

Une \textbf{feuille de résultats} (par binôme) accompagne ce sujet. Vous devez reporter les principaux résultats des TP.

Une auto-évaluation des compétences techniques (en lien avec l'approche par compétence mise en place à l'Institut d'Optique) est fournie pour les TP 1 et 2.

\medskip

Vous devrez présenter l'\textbf{ensemble des livrables attendus} pour justifier de la validité de vos résultats (mentionnés dans la feuille de résultats) : protocoles, résultats, analyse et comparaison au modèle théorique. %Lors de cette validation, il peut vous être demandé de faire à nouveau une des mesures présentées.
...
Vous devrez notamment proposer une \textbf{étude comparative} des 4 montages étudiés (photodétection simple, suiveur, transimpédance simple et transimpédance avec filtrage), incluant le protocole de validation des performances de ces montages.
...
\ifodd\value{page}\else
  \hbox{}\newpage
\fi
\input{seances/S5_Opto_TP_Seances3_4.tex}
...
\ifodd\value{page}\else
  \hbox{}\newpage
\fi
\input{seances/S5_Opto_TP_Seance6.tex}
...
\includepdf[pages={1,4-6}]{../apc/IOGS-GrillesCompétences2025-2026.pdf}

\includepdf[pages=-]{../apc/GrillesCRs-1A.pdf}
\includepdf[pages=-,landscape=true]{../apc/S5_Optoelectronique_2024_AutoEval_Indiv.pdf}
\includepdf[pages=-,landscape=true]{images/phd_slave_d25_sch.pdf}
