...
Une seconde maquette permettra également de \textbf{comparer une version améliorée du transimpédance} et l'\textbf{impact de la tension de polarisation} sur les performances dynamiques du montage.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Travail à réaliser autour des maquettes}
...
\section{Maquette 1 / Étude comparative de 4 montages}
...
\begin{center}
\begin{tabular}{|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{10cm}|}
