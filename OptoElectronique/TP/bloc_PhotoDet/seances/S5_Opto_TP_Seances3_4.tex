...
PRESENTATION MAQUETTES (3 montages et 2 montages transimpédance)
...
Pour cela, on souhaite pouvoir remplir le tableau suivant (\textbf{à reproduire dans votre cahier de laboratoire} pour chaque montage) et \textbf{caractériser la réponse en fréquence et en temps des trois circuits} suivants (première maquette) : photodétection simple, photodétection avec suiveur, montage transimpédance.
