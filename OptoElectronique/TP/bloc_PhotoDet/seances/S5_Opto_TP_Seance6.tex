...
5N-027-SCI \qquad \textbf{\Large TP Séance 4}
...
Au cours de cette dernière séance, vous aurez à choisir parmi l'une des 3 possibilités suivantes :
...
\textbf{Ces sujets ne sont à réaliser qu'une fois le travail sur la photodétection est terminé.} Vous devez au préalable avoir fini et validé votre analyse comaparative des différents montages de photodétection pour les différentes valeurs de $R_{PHD}$.
