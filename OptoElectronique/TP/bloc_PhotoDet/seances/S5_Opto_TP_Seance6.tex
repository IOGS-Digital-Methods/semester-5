...
Au cours de cette dernière séance, vous aurez à choisir parmi l'une des 4 possibilités suivantes :
...
\begin{itemize}[label=$\square$]
	...
	\item mettre en place un système de \textbf{régulation d'intensité lumineuse}
