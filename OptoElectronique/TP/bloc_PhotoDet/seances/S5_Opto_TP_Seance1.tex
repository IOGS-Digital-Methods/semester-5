...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Etude d'un montage simple de photodétection - \textit{Durée : 60 min}}
...
On souhaite pouvoir remplir le tableau 1 de la feuille de résultats du TP1.

\medskip

\Quest Proposer des protocoles (avec les schémas associés incluant les appareils de mesure) pour mesurer l'\textbf{intensité lumineuse} ($\Phi_e$), l'\textbf{intensité du courant dans la photodiode} ($I_{photo}$) et la \textbf{tension de sortie du montage} ($V_S$) lorsque la photodiode est dans l'obscurité, plongée dans un le flux ambiant de la pièce ou éclairée par une lampe de bureau.
...
\Quest Quels sont les ordres de grandeur des courants mesurés ?
...
Pour cela, on souhaite pouvoir remplir le tableau 2 de la feuille de résultats du TP1.
